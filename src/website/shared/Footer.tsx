...
function NewsLetterFooter() {
  ...
  return (
    <div className="relative w-full pb-20 lg:pb-24 flex overflow-hidden">
      <Image
        alt="Newsletter subscription"
        src="/assets/footer.jpg"
        fill
        className="object-cover absolute scale-105 transition-transform duration-700 hover:scale-100"
      />
